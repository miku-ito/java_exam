...
public class BaseballRepository {
	...
	public List<BaseballDomain> findStadium(){
		String sql = "SELECT t.id, t.name, t.established_date, s.name FROM teams t INNER JOIN stadiums s ON t.stadium_id = s.id ORDER BY established_date ASC";
